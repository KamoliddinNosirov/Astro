    ...
    <>
      <header>
        <nav>
          <div className="container">
            ...
            <div className="icons">
              <img src="/soroq.svg" alt="" />
              <img src="/eathr.svg" alt="" />
              <img src="/user.svg" alt="" />
            </div>
            <p>Menu <img src="/menu.svg" alt="" /></p>
          </div>
        </nav>
        <div className="hero">
          <div className="container">
      ...
      <main>
        <section className="our-mission">
          <img className='section-bg2' src="/bg2.png" alt="" />
          <div className="container">
            ...
            <div className="cards">
              <div className="card">
                ...
                <div className="price">
                  ...
                  <p>Learn more <img src="/right.svg" alt="" /></p>
                </div>
              </div>
        ...
        <section className="find">
          <div className="container">
            <div className="box">
              ...
              <button><img src="/loc.svg" alt="" />Use my current location</button>
            </div>
          </div>
        </section>
        <section className="full-section">
          <div className="container">
            <div className="section-info">
              <h1>Come and build a sustainable future with us. Join <img src="/Vector.png" alt="" /></h1>
      ...
      <footer>
        <div className="container">
          ...
          <ul>
            <li><a href=""><img src="/sms.svg" alt="" />hello@astra.com</a></li>
            <li><a href="">Facebook</a></li>
            <li><a href="">Instagram</a></li>
            <li><a href="">Twitter</a></li>
          </ul>
          <img className='img-none' src="/lin2.png" alt="" />
          <img className='linefull' src="/Line 15.png" alt="" />
          <p>Privacy Policy</p>
